#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validator v83 Track C — Runner Wave5 Mode."""
import json, sys, re
...
def main():
    ...
    marker = _load(ROOT / "data/design/economy/pve_reward_claim_canary_runner_wave5_marker_v1.json")
    if not runner.exists(): ERR.append("missing:runner")
    else:
        src = runner.read_text(encoding="utf-8")
        for needle in ("--wave5-preflight", "--wave5-apply", "--wave5-observe", "--wave5-rollback-drill",
                       "PVE_REWARD_CLAIM_CANARY_WAVE5", "LOCAL_FILE_STAGING",
                       "VALID_WAVE5_ROUTES", "FORBIDDEN_REWARD_KEYS_WAVE5",
                       "real_account_id_reject", "real_account_id_forbidden_in_canary"):
    ...
    if ERR:
        print("FAIL pve_reward_claim_canary_runner_wave5:", "; ".join(ERR)); return 1
    print("PASS pve_reward_claim_canary_runner_wave5"); return 0
