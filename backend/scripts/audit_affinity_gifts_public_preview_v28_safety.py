#!/usr/bin/env python3
"""V28 PART I — UI safety V28."""
import json, re, sys
from datetime import datetime, timezone
from pathlib import Path

OUT = Path('/app/data/design/ui/affinity_gifts_public_preview_v28_safety_result.json')
...
CRITICAL = [
    ...
    (r"onPress\s*=\s*\{[^}]*\b(?:gift[_\-]?spend|affinity[_\-]?gift|gift_give)\b", 'onPress gift mutation'),
...
def main():
    ...
    out = {
        'task_origin': 'AF2-N-V28-UI-PUBLIC-PREVIEW-SAFETY',
