...
d = json.load(open(os.path.join(R, 'data/design/v110_pack_89_inventory_psp_scoped/v110_pack_89_baseline_multirun_v1.json')))
...
print(f'[v110 PACK_89_BASELINE_MULTIRUN] OK run1=run2=run3={p1} required=0 miss=0')
