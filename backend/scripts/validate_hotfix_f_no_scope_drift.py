"""HOTFIX F — Validator 4/4: No Scope Drift.
...
Allowed scope:
  ...
  data/design/system_safety/hotfix_f_*.json
  docs/divine/541_HOTFIX_F_LOBBY_COMBAT_TEAMFORMATION_V1*.md
...
def main() -> int:
    ...
    if forbidden_touched or out_of_scope:
        print("HOTFIX F — VALIDATOR 4 (no_scope_drift): FAIL", file=sys.stderr)
    ...
    print("HOTFIX F — VALIDATOR 4 (no_scope_drift): PASS")
