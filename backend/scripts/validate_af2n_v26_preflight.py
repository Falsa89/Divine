#!/usr/bin/env python3
"""V26 PART A — Validator for preflight."""
import json, sys
from pathlib import Path
P = Path('/app/data/design/affinity/af2n_v26_preflight_result_v1.json')
...
def main():
    ...
    c = d.get('checks', {})
    if c.get('heroes_count') != 100: print('FAIL: heroes_count'); return 2
    ...
    if c.get('battle_runtime_attached') is not False: print('FAIL: battle_attached'); return 2
    if not all((c.get('guardrail_diffs_clean') or {}).values()): print('FAIL: guardrails'); return 2
    if not c.get('v25_all_present'): print('FAIL: v25_deliverables'); return 2
    print('PASS: AF2-N-V26-PREFLIGHT'); return 0
