...
P=os.path.join(R,"data/design/v109_server_isolation/v109_server_isolation_final_multirun_v1.json")
...
assert opt<=tmax
print(f"[v109 FINAL_MULTIRUN] OK required=0 miss=0 optional={opt} target_max={tmax}")
