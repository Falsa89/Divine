#!/usr/bin/env python3
"""V23 — Validate Locust stage4 rate-limit result."""
from __future__ import annotations
import json, sys
from pathlib import Path

R = Path('/app/data/design/affinity/af2n_v23_locust_stage4_ratelimit_result_v1.json')
...
def main():
    ...
    print('PASS: AF2-L-LOCUST-STAGE4-V23'); return 0
