...
P = Path('/app/data/design/affinity/af2n_scope_s1_extended_monitoring_v29_result.json')
def main():
    ...
    if d.get('fresh_spend_count', 99) > 15: print('FAIL: fresh_cap'); return 2
    print('PASS: AF2-N-V29-SCOPE-S1-EXTENDED-MONITORING'); return 0
