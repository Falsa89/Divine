#!/usr/bin/env python3
# Validator: PROJECT-EVENT-ARENA-ALPHA-GATE-PREVIEW-UI
...
SCREEN = "frontend/app/event-arena-alpha-gate-preview.tsx"
MARKER = "data/design/modes/event_arena_alpha_gate_preview_ui_marker_v1.json"
...
REQUIRED_SUBSTRINGS = [
    ...
    "arena_ranking_enabled",
    "event_currency_enabled",
]
...
def main() -> int:
    ...
    if errors:
        for e in errors:
            print(e)
        return 1
    print("PROJECT-EVENT-ARENA-ALPHA-GATE-PREVIEW-UI: PASS")
    return 0
