#!/usr/bin/env python3
"""
RM1.22-C — Apply Placeholder Assets to 1★/2★ Official Hero Folders

Copies shared placeholder assets from:
...
MANIFEST_PATH = ROOT / "data/design/placeholder_assignment_1star_2star_manifest.json"
...
def patch_battle_metadata(path: Path, hero_id: str, profile: str) -> None:
    ...
    data["source"] = "RM1.22-C placeholder assignment"
...
def main() -> int:
    ...
    print("=== RM1.22-C Placeholder Assignment 1★/2★ ===")
    ...
    if args.apply:
        ...
        # Patch battle_animations.json and add placeholder_status.json per hero.
        for target in targets:
            dest_root = ROOT / target["destination_root"]
        ...
        report_path = REPORTS_DIR / f"placeholder_assignment_1star_2star_APPLIED_{ts}.json"
        report = {
