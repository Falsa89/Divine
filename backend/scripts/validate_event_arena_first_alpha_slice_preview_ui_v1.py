#!/usr/bin/env python3
# Validator: PROJECT-EVENT-ARENA-FIRST-ALPHA-SLICE-PREVIEW-UI
...
SCREEN = "frontend/app/event-arena-first-alpha-slice-preview.tsx"
MARKER = "data/design/modes/event_arena_first_alpha_slice_preview_ui_marker_v1.json"
...
REQUIRED_SUBSTRINGS = [
    "DEEPLINK-ONLY", "Event First Alpha Slice", "Arena First Alpha Slice",
    "result_authoritative", "reward_grant_enabled",
...
def main() -> int:
    ...
    if marker.get("event_currency_enabled") is not False:
        errors.append("MARKER_BAD_EVENT_CURRENCY")
    if marker.get("arena_ranking_enabled") is not False:
        errors.append("MARKER_BAD_ARENA_RANKING")

    if errors:
        for e in errors:
            print(e)
        return 1
    print("PROJECT-EVENT-ARENA-FIRST-ALPHA-SLICE-PREVIEW-UI: PASS")
    return 0
