...
d = json.load(open(os.path.join(R, 'data/design/v110_pack_87_server_scoped_starter_flow/v110_pack_87_baseline_multirun_v1.json')))
...
print(f'[v110 PACK_87_BASELINE_MULTIRUN] OK run1=run2=run3={p1} required=0 miss=0 deterministic=true')
