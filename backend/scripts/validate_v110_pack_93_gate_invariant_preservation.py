...
d = json.load(open(os.path.join(R, 'data/design/v110_pack_93_economy_progress_write_paths/v110_pack_93_gate_invariant_preservation_v1.json')))
g = d.get('gates', {})
