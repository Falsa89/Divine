#!/usr/bin/env python3
# Validator: PROJECT-ALPHA-PREVIEW-SAFE-HUB
...
SCREEN = "frontend/app/alpha-preview-hub.tsx"
MARKER = "data/design/navigation/alpha_preview_safe_hub_marker_v1.json"
...
REQUIRED_SUBSTRINGS = [
    "DEEPLINK-ONLY", "ALPHA PREVIEW HUB",
...
def main() -> int:
    ...
    if marker.get("public_menu_routing_enabled") is not False:
        errors.append("MARKER_PUBLIC_MENU")

    if errors:
        for e in errors:
            print(e)
        return 1
    print("PROJECT-ALPHA-PREVIEW-SAFE-HUB: PASS")
    return 0
