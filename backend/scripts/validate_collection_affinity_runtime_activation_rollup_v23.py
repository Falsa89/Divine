...
P = Path('/app/data/design/system_safety/collection_affinity_runtime_activation_readiness_rollup_v23.json')
def main():
    ...
    if d.get('canary_ledger_cap') != 25000: print('FAIL: cap'); return 2
    ...
    print('PASS: AF2-N-V28-SAFETY-ROLLUP-W'); return 0
