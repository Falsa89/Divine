#!/usr/bin/env python3
"""Pack 101 cleanup: rimuove artefatti marcati `pack_101_test_artifact`. Reset kill switches."""
...
COLLECTIONS = [
    ...
    'tower_progress',  # legacy collection - should always be empty for pack 101 users
]
...
async def cleanup(apply_mode: bool):
    ...
    for col in COLLECTIONS:
        if col == 'tower_progress':
            # No marker on tower_progress (legacy collection). Skip dry-run, just count.
            cnt = 0
        else:
