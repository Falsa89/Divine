...
assert m == 'f8b770a118548602a7f680f59b6c409c', f'lobby current md5 mismatch: {m}'
...
assert "== 'f8b770a118548602a7f680f59b6c409c'" in p79, 'Pack 79 validator assert not rebased'
