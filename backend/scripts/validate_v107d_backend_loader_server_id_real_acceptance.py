...
p=os.path.join(R,'data','design','server_scope','v107d_backend_loader_server_id_real_acceptance_result_v1.json')
d=json.load(open(p,encoding='utf-8'))
if d.get('feature_flag_default',True): print('FAIL flag'); sys.exit(1)
if d.get('adoption_status')!='V107C_PROBE_ROUTER_LIVE_NO_NEW_LOADER_MODIFIED_v107D': print('FAIL adoption'); sys.exit(1)
if d.get('probe_endpoints_live',0)!=5: print('FAIL probes'); sys.exit(1)
if d.get('existing_loader_endpoints_modified_v107d',-1)!=0: print('FAIL loader_modified'); sys.exit(1)
...
print('PASS \u2014 v107D backend loader server_id real acceptance (5 probes via v107C, 0 new modified)'); sys.exit(0)
