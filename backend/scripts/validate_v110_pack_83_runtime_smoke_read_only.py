...
# Pack 84 post-normalization: direct_uuid. Pre-Pack 84: objectid_compat_fallback. Both accepted.
assert h.get('x-psp-lookup-mode') in ('direct_uuid', 'objectid_compat_fallback')
