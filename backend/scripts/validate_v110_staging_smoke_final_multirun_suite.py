...
P = os.path.join(R, "data/design/v110_psp_apply_staging_smoke/v110_staging_smoke_final_multirun_suite_result_v1.json")
...
print(f"[v110 STAGING_SMOKE_FINAL_MULTIRUN] OK required=0 miss=0 optional={opt} target_max={tmax}")
