#!/usr/bin/env python3
"""SLC-BE-PREFLIGHT v2 (PROJECT_E Track A) — reads _slc_c_combo_v2_result.json."""
import json, sys
...
def fail(m): print(f"[slc_be_preflight_v2] FAIL {m}"); sys.exit(1)
...
def main():
    ...
    print("[slc_be_preflight_v2] PASS upstream SLC-C combo v2 OK")
    sys.exit(0)
