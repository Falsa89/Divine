...
P = os.path.join(R, "data/design/v110_psp_apply_preflight/v110_apply_preflight_final_multirun_suite_result_v1.json")
...
print(f"[v110 APPLY_PREFLIGHT_FINAL_MULTIRUN] OK required=0 miss=0 optional={opt} target_max={tmax}")
