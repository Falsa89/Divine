...
OPTIONAL = [
    ...
    # Pack 93 — Economy/progress/equipment write paths megapack: 16 track + 1 rollup.
    ('PROJECT-V110-PACK-93-BASELINE-MULTIRUN', 'validate_v110_pack_93_baseline_multirun.py'),
    ('PROJECT-V110-PACK-93-WRITE-PATH-AUDIT', 'validate_v110_pack_93_write_path_audit.py'),
    ('PROJECT-V110-PACK-93-CURRENCY-WRITE-GUARD', 'validate_v110_pack_93_currency_write_guard.py'),
    ('PROJECT-V110-PACK-93-STORY-PROGRESS-WRITE-GUARD', 'validate_v110_pack_93_story_progress_write_guard.py'),
    ('PROJECT-V110-PACK-93-EQUIPMENT-BACKFILL-PREFLIGHT', 'validate_v110_pack_93_equipment_backfill_preflight.py'),
    ('PROJECT-V110-PACK-93-EQUIPMENT-WRITE-GUARD', 'validate_v110_pack_93_equipment_write_guard.py'),
    ('PROJECT-V110-PACK-93-REWARD-CLAIM-LEDGER-DESIGN', 'validate_v110_pack_93_reward_claim_ledger_design.py'),
    ('PROJECT-V110-PACK-93-FRONTEND-WRITE-CONSUMER-GUARD', 'validate_v110_pack_93_frontend_write_consumer_guard.py'),
    ('PROJECT-V110-PACK-93-RUNTIME-SMOKE-E2E', 'validate_v110_pack_93_runtime_smoke_e2e.py'),
    ('PROJECT-V110-PACK-93-STATIC-ANTI-ACCOUNT-WIDE-WRITE-GUARD', 'validate_v110_pack_93_static_anti_account_wide_write_guard.py'),
    ('PROJECT-V110-PACK-93-DATA-INVARIANTS', 'validate_v110_pack_93_data_invariants.py'),
    ('PROJECT-V110-PACK-93-CLEANUP-ROLLBACK', 'validate_v110_pack_93_cleanup_rollback.py'),
    ('PROJECT-V110-PACK-93-LIVE-READINESS-UPDATE', 'validate_v110_pack_93_live_readiness_update.py'),
    ('PROJECT-V110-PACK-93-MD5-REBASE', 'validate_v110_pack_93_md5_rebase.py'),
    ('PROJECT-V110-PACK-93-GATE-INVARIANT-PRESERVATION', 'validate_v110_pack_93_gate_invariant_preservation.py'),
    ...
    # Pack 95 — Reward claim ledger runtime foundation + story progress write strict + legacy reward/currency/shop/soul quarantine.
    ('PROJECT-V110-PACK-95-BASELINE-MULTIRUN', 'validate_v110_pack_95_baseline_multirun.py'),
    ('PROJECT-V110-PACK-95-WRITE-PATH-AUDIT', 'validate_v110_pack_95_write_path_audit.py'),
    ('PROJECT-V110-PACK-95-REWARD-CLAIM-LEDGER-RUNTIME-FOUNDATION', 'validate_v110_pack_95_reward_claim_ledger_runtime_foundation.py'),
    ('PROJECT-V110-PACK-95-STORY-PROGRESS-WRITE-STRICT', 'validate_v110_pack_95_story_progress_write_strict.py'),
    ('PROJECT-V110-PACK-95-LEGACY-CURRENCY-QUARANTINE', 'validate_v110_pack_95_legacy_currency_quarantine.py'),
    ('PROJECT-V110-PACK-95-SHOPS-BUY-GUARD', 'validate_v110_pack_95_shops_buy_guard.py'),
    ('PROJECT-V110-PACK-95-SOUL-FORGE-RETIRE-GUARD', 'validate_v110_pack_95_soul_forge_retire_guard.py'),
    ('PROJECT-V110-PACK-95-FRONTEND-CONSUMER-GUARD', 'validate_v110_pack_95_frontend_consumer_guard.py'),
    ('PROJECT-V110-PACK-95-RUNTIME-SMOKE-E2E', 'validate_v110_pack_95_runtime_smoke_e2e.py'),
    ('PROJECT-V110-PACK-95-STATIC-ANTI-DOUBLE-GRANT-GUARD', 'validate_v110_pack_95_static_anti_double_grant_guard.py'),
    ('PROJECT-V110-PACK-95-DATA-INVARIANTS', 'validate_v110_pack_95_data_invariants.py'),
    ('PROJECT-V110-PACK-95-CLEANUP-ROLLBACK', 'validate_v110_pack_95_cleanup_rollback.py'),
    ('PROJECT-V110-PACK-95-LIVE-READINESS-UPDATE', 'validate_v110_pack_95_live_readiness_update.py'),
    ('PROJECT-V110-PACK-95-MD5-REBASE', 'validate_v110_pack_95_md5_rebase.py'),
    ('PROJECT-V110-PACK-95-GATE-INVARIANT-PRESERVATION', 'validate_v110_pack_95_gate_invariant_preservation.py'),
    ('PROJECT-V110-PACK-95-FINAL-MULTIRUN-SUITE', 'validate_v110_pack_95_final_multirun_suite.py'),
    ('MEGA-RELEASE-ACCELERATION-95-REWARD-LEDGER-STORY-WRITE-LEGACY-REWARD-CURRENCY-MEGAPACK-ROLLUP', 'validate_mega_release_acceleration_95_reward_ledger_story_write_legacy_reward_currency_megapack_rollup.py'),

    # Pack 96 — Reward claim ledger LIVE execute + controlled claim paths (allowlisted).
    ('PROJECT-V110-PACK-96-BASELINE-MULTIRUN', 'validate_v110_pack_96_baseline_multirun.py'),
    ('PROJECT-V110-PACK-96-REWARD-LEDGER-LIVE-PREFLIGHT', 'validate_v110_pack_96_reward_ledger_live_preflight.py'),
    ('PROJECT-V110-PACK-96-REWARD-SOURCE-REGISTRY', 'validate_v110_pack_96_reward_source_registry.py'),
    ('PROJECT-V110-PACK-96-CONTROLLED-CLAIM-ENDPOINT', 'validate_v110_pack_96_controlled_claim_endpoint.py'),
    ('PROJECT-V110-PACK-96-FIRST-CONTROLLED-CLAIM-SOURCES', 'validate_v110_pack_96_first_controlled_claim_sources.py'),
    ('PROJECT-V110-PACK-96-GRANT-ENGINE-GUARD', 'validate_v110_pack_96_grant_engine_guard.py'),
    ('PROJECT-V110-PACK-96-LEGACY-CLAIM-BRIDGE-GUARDS', 'validate_v110_pack_96_legacy_claim_bridge_guards.py'),
    ('PROJECT-V110-PACK-96-FRONTEND-CONSUMER-GUARD', 'validate_v110_pack_96_frontend_consumer_guard.py'),
    ('PROJECT-V110-PACK-96-RUNTIME-SMOKE-E2E', 'validate_v110_pack_96_runtime_smoke_e2e.py'),
    ('PROJECT-V110-PACK-96-STATIC-ANTI-BYPASS-GUARD', 'validate_v110_pack_96_static_anti_bypass_guard.py'),
    ('PROJECT-V110-PACK-96-INDEX-LEDGER-MIGRATION-SAFETY', 'validate_v110_pack_96_index_ledger_migration_safety.py'),
    ('PROJECT-V110-PACK-96-DATA-INVARIANTS', 'validate_v110_pack_96_data_invariants.py'),
    ('PROJECT-V110-PACK-96-CLEANUP-ROLLBACK-KILL-SWITCH', 'validate_v110_pack_96_cleanup_rollback_kill_switch.py'),
    ('PROJECT-V110-PACK-96-LIVE-READINESS-UPDATE', 'validate_v110_pack_96_live_readiness_update.py'),
    ('PROJECT-V110-PACK-96-MD5-REBASE', 'validate_v110_pack_96_md5_rebase.py'),
    ('PROJECT-V110-PACK-96-GATE-INVARIANT-PRESERVATION', 'validate_v110_pack_96_gate_invariant_preservation.py'),
    ('PROJECT-V110-PACK-96-FINAL-MULTIRUN-SUITE', 'validate_v110_pack_96_final_multirun_suite.py'),
    ('MEGA-RELEASE-ACCELERATION-96-REWARD-CLAIM-LEDGER-LIVE-EXECUTE-AND-CONTROLLED-CLAIM-PATHS-ROLLUP', 'validate_mega_release_acceleration_96_reward_claim_ledger_live_execute_and_controlled_claim_paths_rollup.py'),

    # Pack 97 — Daily login claim (first real player-facing source) + frontend minimal gated consumer.
    ('PROJECT-V110-PACK-97-BASELINE-MULTIRUN', 'validate_v110_pack_97_baseline_multirun.py'),
    ('PROJECT-V110-PACK-97-DAILY-LOGIN-CLAIM-SOT', 'validate_v110_pack_97_daily_login_claim_sot.py'),
    ('PROJECT-V110-PACK-97-REWARD-REGISTRY-DAILY-SOURCE', 'validate_v110_pack_97_reward_registry_daily_source.py'),
    ('PROJECT-V110-PACK-97-DAILY-CLAIM-ENDPOINT', 'validate_v110_pack_97_daily_claim_endpoint.py'),
    ('PROJECT-V110-PACK-97-REWARD-PAYLOAD-GUARD', 'validate_v110_pack_97_reward_payload_guard.py'),
    ('PROJECT-V110-PACK-97-FRONTEND-CONSUMER-UNLOCK', 'validate_v110_pack_97_frontend_consumer_unlock.py'),
    ('PROJECT-V110-PACK-97-KILL-SWITCH-AND-FLAGS', 'validate_v110_pack_97_kill_switch_and_flags.py'),
    ('PROJECT-V110-PACK-97-RUNTIME-SMOKE-E2E', 'validate_v110_pack_97_runtime_smoke_e2e.py'),
    ('PROJECT-V110-PACK-97-STATIC-DAILY-ANTI-DOUBLE-CLAIM-GUARD', 'validate_v110_pack_97_static_daily_anti_double_claim_guard.py'),
    ('PROJECT-V110-PACK-97-LEGACY-CLAIM-NON-REGRESSION', 'validate_v110_pack_97_legacy_claim_non_regression.py'),
    ('PROJECT-V110-PACK-97-DATA-INVARIANTS', 'validate_v110_pack_97_data_invariants.py'),
    ('PROJECT-V110-PACK-97-CLEANUP-ROLLBACK', 'validate_v110_pack_97_cleanup_rollback.py'),
    ('PROJECT-V110-PACK-97-LIVE-READINESS-UPDATE', 'validate_v110_pack_97_live_readiness_update.py'),
    ('PROJECT-V110-PACK-97-MD5-REBASE', 'validate_v110_pack_97_md5_rebase.py'),
    ('PROJECT-V110-PACK-97-GATE-INVARIANT-PRESERVATION', 'validate_v110_pack_97_gate_invariant_preservation.py'),
    ('PROJECT-V110-PACK-97-FINAL-MULTIRUN-SUITE', 'validate_v110_pack_97_final_multirun_suite.py'),
    ('MEGA-RELEASE-ACCELERATION-97-FIRST-REAL-CLAIM-SOURCE-AND-FRONTEND-REWARD-UNLOCK-ROLLUP', 'validate_mega_release_acceleration_97_first_real_claim_source_and_frontend_reward_unlock_rollup.py'),

    # Pack 98 — Daily home unlock + daily_quest_completion_claim (second real source).
    ('PROJECT-V110-PACK-98-BASELINE-MULTIRUN', 'validate_v110_pack_98_baseline_multirun.py'),
    ('PROJECT-V110-PACK-98-DAILY-HOME-UNLOCK-SOT', 'validate_v110_pack_98_daily_home_unlock_sot.py'),
    ('PROJECT-V110-PACK-98-DAILY-LOGIN-HOME-INTEGRATION', 'validate_v110_pack_98_daily_login_home_integration.py'),
    ('PROJECT-V110-PACK-98-DAILY-QUEST-CLAIM-SOT', 'validate_v110_pack_98_daily_quest_claim_sot.py'),
    ('PROJECT-V110-PACK-98-REWARD-REGISTRY-DAILY-QUEST-SOURCE', 'validate_v110_pack_98_reward_registry_daily_quest_source.py'),
    ('PROJECT-V110-PACK-98-DAILY-QUEST-ENDPOINT', 'validate_v110_pack_98_daily_quest_endpoint.py'),
    ('PROJECT-V110-PACK-98-REWARD-PAYLOAD-GUARD', 'validate_v110_pack_98_reward_payload_guard.py'),
    ('PROJECT-V110-PACK-98-FRONTEND-DAILY-QUEST-GUARD', 'validate_v110_pack_98_frontend_daily_quest_guard.py'),
    ('PROJECT-V110-PACK-98-KILL-SWITCH-AND-FLAGS', 'validate_v110_pack_98_kill_switch_and_flags.py'),
    ('PROJECT-V110-PACK-98-RUNTIME-SMOKE-E2E', 'validate_v110_pack_98_runtime_smoke_e2e.py'),
    ('PROJECT-V110-PACK-98-STATIC-ANTI-DOUBLE-CLAIM-UI-LEAK-GUARD', 'validate_v110_pack_98_static_anti_double_claim_ui_leak_guard.py'),
    ('PROJECT-V110-PACK-98-LEGACY-CLAIM-NON-REGRESSION', 'validate_v110_pack_98_legacy_claim_non_regression.py'),
    ('PROJECT-V110-PACK-98-DATA-INVARIANTS', 'validate_v110_pack_98_data_invariants.py'),
    ('PROJECT-V110-PACK-98-CLEANUP-ROLLBACK', 'validate_v110_pack_98_cleanup_rollback.py'),
    ('PROJECT-V110-PACK-98-LIVE-READINESS-UPDATE', 'validate_v110_pack_98_live_readiness_update.py'),
    ('PROJECT-V110-PACK-98-MD5-REBASE', 'validate_v110_pack_98_md5_rebase.py'),
    ('PROJECT-V110-PACK-98-GATE-INVARIANT-PRESERVATION', 'validate_v110_pack_98_gate_invariant_preservation.py'),
    ...
    # Pack 108 — Guild Server-Scope Retrofit + Frontend Playable Loop Polish.
    ('PROJECT-V110-PACK-108-SOT', 'validate_v110_pack_108_sot.py'),
    ('PROJECT-V110-PACK-108-GUILD-STRICT-ENDPOINTS', 'validate_v110_pack_108_guild_strict_endpoints.py'),
    ('PROJECT-V110-PACK-108-GUILD-LEGACY-QUARANTINE', 'validate_v110_pack_108_guild_legacy_quarantine.py'),
    ('PROJECT-V110-PACK-108-GUILD-REWARD-LOCK', 'validate_v110_pack_108_guild_reward_lock.py'),
    ('PROJECT-V110-PACK-108-ARENA-PVP-EVENT-PRESERVATION', 'validate_v110_pack_108_arena_pvp_event_preservation.py'),
    ('PROJECT-V110-PACK-108-FRONTEND-PLAYABLE-LOOP-MAP', 'validate_v110_pack_108_frontend_playable_loop_map.py'),
    ('PROJECT-V110-PACK-108-FRONTEND-UI-FLAGS-DEFAULT-OFF', 'validate_v110_pack_108_frontend_ui_flags_default_off.py'),
    ('PROJECT-V110-PACK-108-SERVER-SWITCH-REFRESH-GUARD', 'validate_v110_pack_108_server_switch_refresh_guard.py'),
    ('PROJECT-V110-PACK-108-LOCKED-DEFERRED-UI-COPY-AUDIT', 'validate_v110_pack_108_locked_deferred_ui_copy_audit.py'),
    ('PROJECT-V110-PACK-108-RUNTIME-SMOKE-E2E', 'validate_v110_pack_108_runtime_smoke_e2e.py'),
    ('PROJECT-V110-PACK-108-STATIC-ANTI-LEAK-GUARD', 'validate_v110_pack_108_static_anti_leak_guard.py'),
    ('PROJECT-V110-PACK-108-DATA-INVARIANTS', 'validate_v110_pack_108_data_invariants.py'),
    ('PROJECT-V110-PACK-108-GATE-INVARIANT-PRESERVATION', 'validate_v110_pack_108_gate_invariant_preservation.py'),
    ('PROJECT-V110-PACK-108-CLEANUP-ROLLBACK', 'validate_v110_pack_108_cleanup_rollback.py'),
    ('PROJECT-V110-PACK-108-LIVE-READINESS-UPDATE', 'validate_v110_pack_108_live_readiness_update.py'),
    ('MEGA-RELEASE-ACCELERATION-108-GUILD-SERVER-SCOPE-RETROFIT-FRONTEND-PLAYABLE-LOOP-POLISH-ROLLUP', 'validate_mega_release_acceleration_108_guild_server_scope_retrofit_frontend_playable_loop_polish_rollup.py'),

    # Pack 109 — Closed Alpha RC Sweep + Release Gate.
    ('PROJECT-V110-PACK-109-SOT', 'validate_v110_pack_109_sot.py'),
    ('PROJECT-V110-PACK-109-PACK-91-108-PRESERVATION', 'validate_v110_pack_109_pack_91_108_preservation.py'),
    ('PROJECT-V110-PACK-109-SERVER-PROFILE-ISOLATION-AUDIT', 'validate_v110_pack_109_server_profile_isolation_audit.py'),
    ('PROJECT-V110-PACK-109-AUTH-LOGOUT-SERVER-SELECTION-AUDIT', 'validate_v110_pack_109_auth_logout_server_selection_audit.py'),
    ('PROJECT-V110-PACK-109-FRONTEND-NAVIGATION-PLAYABLE-LOOP-RC', 'validate_v110_pack_109_frontend_navigation_playable_loop_rc.py'),
    ('PROJECT-V110-PACK-109-STORY-BATTLE-PREVIEW-STAGING-RC', 'validate_v110_pack_109_story_battle_preview_staging_rc.py'),
    ('PROJECT-V110-PACK-109-TOWER-RC', 'validate_v110_pack_109_tower_rc.py'),
    ('PROJECT-V110-PACK-109-DAILY-DAILYQUEST-CONTROLLED-REWARDS-RC', 'validate_v110_pack_109_daily_dailyquest_controlled_rewards_rc.py'),
    ('PROJECT-V110-PACK-109-ECONOMY-STRICT-RC', 'validate_v110_pack_109_economy_strict_rc.py'),
    ('PROJECT-V110-PACK-109-INVENTORY-EQUIPMENT-MATERIAL-PSP-RC', 'validate_v110_pack_109_inventory_equipment_material_psp_rc.py'),
    ('PROJECT-V110-PACK-109-GUILD-RC', 'validate_v110_pack_109_guild_rc.py'),
    ('PROJECT-V110-PACK-109-ARENA-PVP-EVENT-RC', 'validate_v110_pack_109_arena_pvp_event_rc.py'),
    ('PROJECT-V110-PACK-109-REWARD-LEDGER-IDEMPOTENCY-RC', 'validate_v110_pack_109_reward_ledger_idempotency_rc.py'),
    ('PROJECT-V110-PACK-109-FORBIDDEN-MUTATION-PREMIUM-IAP-GACHA-GUARD', 'validate_v110_pack_109_forbidden_mutation_premium_iap_gacha_guard.py'),
    ('PROJECT-V110-PACK-109-MOBILE-QA-CHECKLIST', 'validate_v110_pack_109_mobile_qa_checklist.py'),
    ('PROJECT-V110-PACK-109-KNOWN-DEFERRED-BLOCKER-MATRIX', 'validate_v110_pack_109_known_deferred_blocker_matrix.py'),
    ('PROJECT-V110-PACK-109-CLOSED-ALPHA-GATE-VERDICT', 'validate_v110_pack_109_closed_alpha_gate_verdict.py'),
    ('PROJECT-V110-PACK-109-CLEANUP-ROLLBACK-ARTIFACTS', 'validate_v110_pack_109_cleanup_rollback_artifacts.py'),
