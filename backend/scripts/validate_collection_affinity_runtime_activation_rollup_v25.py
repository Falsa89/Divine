...
P = Path('/app/data/design/system_safety/collection_affinity_runtime_activation_readiness_rollup_v25.json')
def main():
    ...
    if d.get('canary_ledger_cap') not in (25000, 50000): print('FAIL: cap'); return 2
    if d.get('allowlist_count') != 2500: print('FAIL: allowlist'); return 2
    if not all((d.get('guardrails_clean') or {}).values()): print('FAIL: guardrails'); return 2
    print('PASS: AF2-N-V30-SAFETY-ROLLUP-Y'); return 0
