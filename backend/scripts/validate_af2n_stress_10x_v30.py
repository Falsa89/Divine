...
P = Path('/app/data/design/affinity/af2n_stress_10x_v30_result.json')
def main():
    ...
    if not s.get('fresh_spend_within_cap'): print('FAIL: fresh_cap'); return 2
    print('PASS: AF2-N-V30-STRESS-10X'); return 0
