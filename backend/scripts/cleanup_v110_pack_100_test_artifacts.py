#!/usr/bin/env python3
"""Pack 100 cleanup script: rimuove artefatti smoke marcati `pack_100_test_artifact`."""
...
async def cleanup(apply_mode: bool):
    ...
    for col in COLLECTIONS:
        filt = {MARKER: True}
        # daily_quest_progress è marcata via _slc_pack_99_tracker (Pack 99 marker preserved)
        if col == 'daily_quest_progress':
            filt = {'_slc_pack_100_completion_via_event_bridge': True}
